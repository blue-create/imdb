...
titles <- unique(titles) # for some reason, there are nodes with nothing but "", which I excluded here
#titles <- titles[-1] # another NA???
...
dat <- data.frame(cbind(titles, desc))

# Issues to be solved: scraping the links isn't perfect and actually includes a lot of NA's and one annoying missing movie title 
```
