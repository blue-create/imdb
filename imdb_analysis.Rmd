...
# Change column names for linear model functionality
...
# Note: French romances have a statistically significant, negative effect on the rating. On the other hand, rating increases if a British movie turns out to be a romance. 
```
