...
stargazer(topics_scraped_model,type = "text", out = "Table 1", 
          ...
          dep.var.labels.include = FALSE,
          column.labels = c("Rating"))
# Note: For some reason, all topics are associated with negative ratings, but the intercept is quite high. Probably due to the moderate-to-low ratings of these movies.
```
...
stargazer(country_model_2020,type = "text", out = "Table 12", 
