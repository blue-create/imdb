...
topics_model_2020 <- lm(Rating ~ Topic_1 + Topic_2 + Topic_3 + 
                      Topic_4 + Topic_5+  Topic_6 + Topic_7 + 
                      Topic_8 + Topic_9 + Topic_10, data = dat_2020)
summary(topics_model_2020)
stargazer(topics_model_2020,type = "text", out = "Table 10", 
          title = "Topic Model: Which Topics have better ratings in 2020?", 
          omit.stat=c("LL","ser","f","adj.rsq"), #omit character vector
          dep.var.labels.include = FALSE,
          column.labels = c("Rating"))
