...
stargazer(topics_only_model, type = "html", out = "Table1.html", 
...
```{r, results = 'asis', warning = FALSE}
stargazer(country_model, type = "html", out = "Table2.html", 
...
```{r, results = 'asis', warning = FALSE}
stargazer(duration_model, type = "html", out = "Table3.html", 
